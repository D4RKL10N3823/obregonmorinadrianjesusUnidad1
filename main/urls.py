...
from .views import AnimeList, AnimeDetail, EpisodeDetail, Login, Signup, Profile, SearchBar, Suggestion, HelpChat
...
urlpatterns = [
    ...
    path('help-chat/', HelpChat.as_view(), name='help_chat'),
